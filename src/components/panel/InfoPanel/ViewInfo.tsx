...
const ViewInfo: React.FC<Props> = ({ view }) => {
  ...
  switch (view) {
    case "NEAs":
      ...
      imageAlt =
        "Asteroid (2867) Steins imaged by the European Rosetta spacecraft in 2008. Credits: European Space Agency/OSIRIS Team";
      break;
    ...
    case "PHAs":
      description = (
        <>
          Potentially Hazardous Asteroids (PHAs) might sound scary, but they
          also present an incredible opportunity! These space rocks could pose a
          threat to Earth if their paths intersect with yours, but they also
          drive the development of innovative technologies for planetary
          defense. Did you know that NEOSSat monitors orbiting space objects to
          help understand their behavior and conduct research on techniques to
          reduce the risk of collisions? It is the first microsatellite used for
          this purpose. You can find more information{" "}
          <ExternalLink
            href="https://www.asc-csa.gc.ca/eng/satellites/neossat/"
  ...
  return (
    <>
      <PanelThing className="mt-5 w-96">
        <div className="p-3">
          <Dropdown
            name={
              <TitleOption2>
